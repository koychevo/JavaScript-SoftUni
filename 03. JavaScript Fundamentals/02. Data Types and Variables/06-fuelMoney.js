function solve(distance, passengers, price) {
    let costs = (distance / 100 * 7 + passengers * 0.1) * price;
    console.log(`Needed money for that trip is ${costs}lv.`);
}
...
/*
Task: Write a function which calculates how much money for fuel will be needed to drive а bus from one place to another.Consider the following:
